              ...
              <div id="page-wrapper">
                  <div class="row">
                      <div class="col-lg-12">
                          ...
                          <i class="fas fa-cogs"></i> Novo Chamado
                          </h2>
                      </div>
                      <!-- /.col-lg-12 -->
                  </div>
                      ...
                      <div class="col-lg-6">
                          <form role="form" method="post" style="width: 500%;">
                              ...
                              <div class="form-group">
                                  ...
                                  <input class="form-control" name="resumo" maxlength="100" value="<?php if(isset($_POST['resumo'])) echo $_POST['resumo']; ?>" placeholder="Tal máquina contém problemas">
                              ...
                              <div class="form-group">
                                  ...
                                  <textarea class="form-control" name="descricao" rows="3" placeholder="Chave de fenda em falta" maxlength="200"><?php if(isset($_POST['descricao'])) echo $_POST['descricao']; ?></textarea>
                              </div>
                              ...
                              <div id="material" class="panel panel-primary" <?php hide(); ?>  >
                                  ...
                                  <div class="panel-body">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <textarea id="desc_material" name="desc_material" class="form-control" rows="3" placeholder="Ex: Solicitação de uma nova ferramenta..."><?php if(isset($_POST['desc_material'])) echo $_POST['desc_material']; ?></textarea>
                                      </div>
                                  </div>
                              </div>
                            <?php endif ?>

                              <input type="hidden" name="secao" value="Mecânica">
...
if (isset($_POST['abrir_os']))
{
  if (empty($_POST['forn_material']) and empty($_POST['desc_material']))
  {
    ...
    if ($insert->insert_into('tb_os_mecanica', $campos[0]) == true)
    {
