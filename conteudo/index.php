...
include '../lib/classes/Filtrar.php';

$class_filtrar = new Filtrar;
$dump_os = new Dump_os;
$dump = new Dump_user;
...
<html lang="pt-br">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-light bg-light static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php"><img src="../lib/sisdf_assets/img/logo_site.png" width="35">Serviço de atendimento técnico</a>
      ...
      <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0" method="post">
        <div class="input-group">
          <input type="text" name="filtro" class="form-control" placeholder="Filtrar chamados" aria-label="Search" aria-describedby="basic-addon2">
